...
class GUIFunctions:
	def allFieldCheck(arg1, arg2):
		if (Functions.GUIdisplay.URL.get() == "empty"):
			# need to display error messaage
			return False
		elif len([v for v in arg1 if v == '']) > 0:
